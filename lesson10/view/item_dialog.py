...
class MyCustomDialog(Dialog):
    ...
    def body(self, master):
        ...
        ttk.Label(master,text=self.date,font=("Helvetica",20,"bold")).pack(pady=20)
        ...
        canvas_left.create_text(100, 40, text=f'AQI:{self.status}',font=("Helvetica",20,"bold"),fill='#9E7A7A')
        self.img = Image.open(path)
        self.green = ImageTk.PhotoImage(self.img)
        canvas_left.create_image(100, 100, anchor='center', image=self.green)
        canvas_left.create_text(100, 160, text=f'AQI:{self.aqi}',font=("Helvetica",20,"bold"),fill='#9E7A7A')
        ...
        canvas_right.create_text(100, 40, text=f'PM2.5:{self.pm25_status}',font=("Helvetica",20,"bold"),fill='#9E7A7A')
        ...
        canvas_right.create_text(100, 160, text=f'PM2.5:{self.pm25}',font=("Helvetica",20,"bold"),fill='#9E7A7A')
