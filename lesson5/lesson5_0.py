...
class Window(ThemedTk):
    def __init__(self,*args,**kwargs):
        ...
        #btn4.bind('<ButtonRelease>', self.left_button_click):這行程式將按鈕釋放事件 (<ButtonRelease>) 綁定到 self.left_button_click 方法。這表示當使用者點擊並鬆開按鈕時，會觸發 self.left_button_click 這個方法。
    ...
    def user_click1(self):
        self.btn1.configure(text="已加入購物車")
        print("成功加入購物車")
